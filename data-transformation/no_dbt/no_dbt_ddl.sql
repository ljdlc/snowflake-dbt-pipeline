...
CREATE OR REPLACE TABLE SF_TPCDS2.ANALYTICS.CUSTOMER_DIM (
	C_SALUTATION VARCHAR(16777216),
	C_PREFERRED_CUST_FLAG VARCHAR(16777216),
	C_FIRST_SALES_DATE_SK NUMBER(38,0),
	C_CUSTOMER_SK NUMBER(38,0),
...
CREATE OR REPLACE TABLE SF_TPCDS2.ANALYTICS.WEEKLY_SALES_INVENTORY (
    ...
    WKS_SUPPLY NUMBER(38,6),
    LOW_STOCK_FLG_WK BOOLEAN
);

CREATE OR REPLACE TABLE SF_TPCDS2.INTERMEDIATE.DAILY_AGGREGATED_SALES (
	WAREHOUSE_SK NUMBER(38,0),
	ITEM_SK NUMBER(38,0),
